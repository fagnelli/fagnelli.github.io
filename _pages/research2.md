...
<p style="text-align: justify;">These architected materials are built from a single constituent material arranged as a network of undulated ribbons. The deformations mechanisms of both single and connected undulated ribbons were analysed using the finite element method to explain the main features of the EBC mechanism. For a particular micro-structure of the proposed class, the complete elastic stiffness tensor was computed combining two-scale homogenization with Kirchhoff-Love plate theory. The range of achievable EBC ratio was then assessed with respect to the geometric parameters of the unit cell. To validate the concept, patterned specimens were manufactured using commercial fused filament fabrication (FFF) 3D printing from Drahi Xnovation Center and tested experimentally under finite strains at Laboratoire de Mécanique des Solides (LMS).</p>

<p style="text-align: justify;">This work lays the foundation for shape-shifting structures that can be paired with responsive materials to create soft robots, compliant mechanisms, and reconfigurable systems capable of autonomous actuation, reducing or eliminating the need for conventional motors, control systems, and power transmission devices.</p>
